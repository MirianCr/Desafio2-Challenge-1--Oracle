...
const elementoLetrasCorretas = document.querySelector('.letras-corretas')
var palavrasChaves = ['ALURA', 'ORACLE', 'CADERNO', 'DESAFIO']
...
function vitoria() {
  ...
  letrasErradas = []
  chanceElemento.textContent = `Chances restantes: ${chances}`
  elementoLetrasCorretas.textContent = `Parabens!Você acertou!`
  var todasAsLetras = document.querySelectorAll('.tracos')
  todasAsLetras.forEach(elemento => {
    elemento.remove()
  })
